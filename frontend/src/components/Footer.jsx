...
const Footer = () => {
  ...
  <img className="w-28 mt-1" src={assets.logo} alt="HealthLink Logo" />
  <p className="text-gray-600 leading-6 md:max-w-[75%]">
    <strong>HealthLink – Effortless Healthcare Scheduling
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            ...
            <li>customersupport@healthlink.in</li>
          </ul>
        </div>
      </div>
      ...
      <p className="py-4 text-sm text-center text-gray-600">
        © 2025 HealthLink.in — All Rights Reserved.
      </p>
    </div>
  );
};
